...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // 1
  // Перейдем к формированю объекта с теми данными, которыми нам надо отправить
  // modalState - это состояние нашего модального окна с калькулятором
  let modalState = {};
  ...
  console.log('DOMContentLoaded работает');
